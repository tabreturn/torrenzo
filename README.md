...
Alternatively, you can use the bare form without backticks or `=`: `[[outline]].assessment.a1.weighting` or `[[outline]].slo.a`. Note, however, that the bare form won't render as a live preview in Obsidian.
