...
# Module 2.1: Introduction to Stone Fruits
...
Assessment 2 requires you to compare two tropical fruits using structured observation frameworks. The stone fruits you encounter in this module make excellent candidates for comparative analysis.

Tasks to undertake in this module to prepare for Assessment 2 include:

- Select two stone fruits and begin recording detailed sensory observations.
- Note the structural similarities (single pit, fleshy mesocarp) and differences (fibre content, skin texture, sweetness).
- Create a draft comparison table with at least four dimensions.
- Photograph both fruits whole, halved, and with the pit exposed.
